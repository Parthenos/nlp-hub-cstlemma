...
<body style="padding: 0 15px;">
	<h3>CSTLemma: The CST Lemmatizer for English</h3>
	<p class="flow-text">CST's lemmatiser reduces all words in a text to their base form, the lemma.</p>
	<div class="row">
	...
	<script type="text/javascript">
		$("#input-textarea").text("Downloading the input text ... please wait");
		...
		var webSocket = $.simpleWebSocket({
			url : protocol + location.hostname
					...
					+ '/nlp-hub-cstlemma/websocketendpoint'
		});
